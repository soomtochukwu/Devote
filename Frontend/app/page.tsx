...
export default function Home() {
  ...
  const steps = [
    {
      ...
      description:
        "Securely connect your blockchain wallet to access the platform.",
    },
    {
  ...
  const testimonials = [
    {
      quote:
        "DeVote has revolutionized how our DAO makes decisions. The transparency and security are unmatched.",
      author: "Sarah Chen",
    ...
    {
      quote:
        "We've increased voter participation by 45% since implementing DeVote for our community decisions.",
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              DeVote is a revolutionary decentralized voting platform that
              leverages blockchain technology to ensure transparent, secure, and
              tamper-proof elections. We're solving the critical issues of
              fraud, lack of transparency, and inefficiency in traditional
              voting systems.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Our blockchain-based system makes vote tampering virtually
                impossible, ensuring election integrity.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Every vote is recorded on a public blockchain, allowing for
            ...
            >
              ...
              <p className="text-muted-foreground">
                Our intuitive interface makes voting accessible to everyone,
      ...
      <section id="features" className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              DeVote combines cutting-edge blockchain technology with a
              user-friendly interface to create the most secure and accessible
      ...
      <section id="how-it-works" className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              DeVote makes blockchain voting simple and accessible in just a few
              steps.
            </p>
          </motion.div>
      ...
      <section id="testimonials" className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              Hear from organizations and communities that have transformed
              their voting process with DeVote.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/10 to-secondary/10">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Join the Future of Voting. Start Now!
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Experience the most secure, transparent, and user-friendly voting
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-muted-foreground mb-4 max-w-md">
                DeVote is revolutionizing the way organizations and communities
                make decisions through secure, transparent blockchain voting
                technology.
              </p>
